...
public class alianzfieldactivity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_alianzfieldactivity);

        final Button gobackButton = (Button) findViewById(R.id.backbutton);
        gobackButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(alianzfieldactivity.this, Activity4fields.class);
